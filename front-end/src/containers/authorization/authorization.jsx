      ...
      <div className={cx("authorization")}>
        ...
        <div className="d-flex align-items-center justify-content-between">
          <form className={cx("search-box")}>
            ...
            <button type="submit"><SearchIcon className={cx("icon")} /></button>
          </form>
              ...
              if(user.role !== "admin") {
                ...
                return (
                  <tr key={user._id} className={cx("tb-row")}>
                    ...
                    <td>{user.name}</td>
                    <td>{user.email}</td>
                    <td>{user.role === "user" && <AccountBoxIcon className={cx("user-icon")} />}</td>
                    <td>{!user.isLocked ? <LockOpenIcon className={cx("is-lock-icon")} /> : <LockPersonIcon className={cx("is-lock-icon")} />}</td>
                    <td>{formattedDate}</td>
                  </tr>
                );
              }
