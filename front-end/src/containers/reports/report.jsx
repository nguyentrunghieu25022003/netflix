                                ...
                                <div key={report._id} className="col-12 mt-3">
                                    <div className={cx("report-item")}>
                                        ...
                                        <div className="d-flex align-items-center justify-content-between">
                                            <strong>URL: </strong>
                                            <Link to={report.videoUrl} target="blank">{report.videoUrl}</Link>
                                            <Link className={cx("check-link")} to={`/admin/movies/edit/${report.movieId}`}>Check</Link>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-between mt-5">
                                            <form className={cx("form-process")}>
                                                <button>{report.processingStatus ? "Success" : "Pending" }</button>
                                            </form>
